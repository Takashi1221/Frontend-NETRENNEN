...
export function HorseCardsNotAuthed({ starters }) {
    ...
    <div className={styles.tableWrapper}>
      {isMobile ? (
        <div className={styles.mobilMainContainer}>
          {enhancedStarters.slice(0, 2).map((horse, index) => (
      ...
      <div className={styles.notAuthedContainer}>
        <div className={styles.moreVert}><MoreVertIcon sx={{fontSize: '2rem'}}/></div>
        <div className={styles.goPremiumContainer}>
          <p>Ab dem 4R nur mit Premium-Zugang sichtbar.</p>
          <p>Abonnieren Sie jetzt und nutzen in vollem Umfang!</p>
